...
func init(subDiv:int):
	print("Terrain2.init().SubDiv=", subDiv)
	SubDivide = subDiv
	
func _ready():
	print("Terrain2.ready().subDivide=", SubDivide)
	translate(Vector3(TerrainX, 0, TerrainY))
	$TerrainPerlinMesh.TerrainX = TerrainX
	$TerrainPerlinMesh.TerrainY = TerrainY
